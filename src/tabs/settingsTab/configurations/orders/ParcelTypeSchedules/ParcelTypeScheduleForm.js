...
const ParcelTypeScheduleForm = ({
  ...
  useEffect(() => {
    ...
    const available = allParcelTypes.filter(
       ...
       :<>
            ...
            {selectedParcelTypes.length > 0 && (
              <Box mb={3}>
                <TableContainer
                  component={Paper}
                  sx={{ boxShadow: 1, border: "1px solid #ddd" }}
                >
                  <Table
                    size="small"
                    sx={{
                    ...
                    <TableBody>
                      {selectedParcelTypes.map((item) => (
                        <TableRow key={item.id}>
                          ...
                          <TableCell>
                            {item.dimensionalFactor || "0.000"}
                          </TableCell>
                          <TableCell>
                            {item.weight ? `${item.weight} lbs` : "0 lbs"}
                          </TableCell>
                          <TableCell>
                            {item.totalUnitFactor || "0.000"}
                          </TableCell>
                          <TableCell>
                            <IconButton
                              size="small"
