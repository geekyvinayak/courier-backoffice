...
const FuleSurchargesScheduleGrid = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    const response = await getRequest("/fuelSurchargeSchedule")
      .then((response) => {
        setRow(response);
        setLoading(false);
      })
  ...
  const handleCellClick = (params) => {
    navigate(`/pricelist/fuel-surcharges-schedule/edit/${params}`);
  };
...
export default FuleSurchargesScheduleGrid;
